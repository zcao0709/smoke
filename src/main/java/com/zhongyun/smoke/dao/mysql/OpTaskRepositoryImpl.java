...
public class OpTaskRepositoryImpl implements OpTaskOther {
    ...
    private static final String SELECT_OPTASK =
            "SELECT o.id, o.eui, o.post_user, o.post_time, o.op_user, o.op_time, o.cause, o.handler, o.worker, o.status, o.project_id, o.mtime, o.ctime, " +
                    "u1.id AS u1id, u1.name AS u1name, u1.phone1 AS u1p1, u1.phone2 AS u1p2, u1.type AS u1type, u1.mtime AS u1mtime, u1.ctime AS u1ctime, " +
                    "u2.id AS u2id, u2.name AS u2name, u2.phone1 AS u2p1, u2.phone2 AS u2p2, u2.type AS u2type, u2.mtime AS u2mtime, u2.ctime AS u2ctime, " +
                    "p.id As pid, p.name AS pname, p.province, p.city, p.district, p.address, p.room_count, p.mtime AS pmtime, p.ctime AS pctime " +
