...
var map = {
	...
	"./common-user/common-user.module": [
...
// import {ProjectService} from "./projects.detail.service"
var SERVICES = [
...
var HeaderComponent = (function () {
    function HeaderComponent(sidebarService, menuService, userService, http, analyticsService, authService, r) {
        ...
        this.userMenu = [{ title: '退出' }];
    }
    HeaderComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.authService.getUserOb()
            .subscribe(function (user) {
            _this.user = user;
            if (_this.user["type"] == "普通用户") {
                setTimeout(function () {
                    _this.toggleSidebar();
                }, 500);
            }
            else if (_this.user["type"] == "管理员") {
            }
        });
        this.authService.getProjectOb()
            .subscribe(function (projects) {
            _this.projectsMenu = projects;
            var index = _this.authService.getIndex();
            if (_this.projectsMenu.length > 0) {
                _this.project = _this.projectsMenu[index];
                _this.project.name = "项目：" + _this.project.name;
    ...
    HeaderComponent.prototype.onMenuItemClick = function (e) {
        if (e['title'] == "退出") {
            this.http.get("/api/logout").toPromise().then(function (res) {
    ...
    HeaderComponent.prototype.changeProject = function (event) {
        console.log(event);
    };
...
HeaderComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__nebular_theme__["k" /* NbSidebarService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__nebular_theme__["k" /* NbSidebarService */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_1__nebular_theme__["g" /* NbMenuService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__nebular_theme__["g" /* NbMenuService */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_2__core_data_users_service__["a" /* UserService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__core_data_users_service__["a" /* UserService */]) === "function" && _c || Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_5__angular_http__["b" /* Http */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_5__angular_http__["b" /* Http */]) === "function" && _d || Object, typeof (_e = typeof __WEBPACK_IMPORTED_MODULE_4__core_utils_analytics_service__["a" /* AnalyticsService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4__core_utils_analytics_service__["a" /* AnalyticsService */]) === "function" && _e || Object, typeof (_f = typeof __WEBPACK_IMPORTED_MODULE_3__auth_auth_service__["a" /* AuthService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__auth_auth_service__["a" /* AuthService */]) === "function" && _f || Object, typeof (_g = typeof __WEBPACK_IMPORTED_MODULE_6__angular_router__["a" /* ActivatedRoute */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_6__angular_router__["a" /* ActivatedRoute */]) === "function" && _g || Object])
], HeaderComponent);
...
var NB_THEME_PROVIDERS = __WEBPACK_IMPORTED_MODULE_4__nebular_theme__["m" /* NbThemeModule */].forRoot({
    name: 'default',
}, [__WEBPACK_IMPORTED_MODULE_8__styles_theme_default__["a" /* DEFAULT_THEME */]]).providers.concat(__WEBPACK_IMPORTED_MODULE_4__nebular_theme__["j" /* NbSidebarModule */].forRoot().providers, __WEBPACK_IMPORTED_MODULE_4__nebular_theme__["f" /* NbMenuModule */].forRoot().providers);
...
AppModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_3__angular_core__["NgModule"])({
        ...
        providers: [
            ...
            __WEBPACK_IMPORTED_MODULE_11__auth_auth_service__["b" /* CanActivateTeam */],
            __WEBPACK_IMPORTED_MODULE_11__auth_auth_service__["d" /* UserToken */],
            __WEBPACK_IMPORTED_MODULE_11__auth_auth_service__["c" /* Permissions */]
        ],
    }),
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_11__auth_auth_service__["a" /* AuthService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_11__auth_auth_service__["a" /* AuthService */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_4__angular_http__["b" /* Http */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4__angular_http__["b" /* Http */]) === "function" && _b || Object])
], AppModule);
...
/* unused harmony export DefaultProjectIndex */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return AuthService; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return UserToken; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return Permissions; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return CanActivateTeam; });
...
var AuthService = (function () {
    ...
    AuthService.prototype.init = function () {
        ...
        this.getUser().then(function (res) {
            ...
            var role = _this.getRol();
            if (role == "普通用户") {
                _this.route.navigateByUrl("/pages/common-user/index");
            }
        }).catch(function (res) {
            _this.goToLogin();
        });
    ...
    AuthService.prototype.getUser = function () {
        return this.http.get("/api/user/v1/logined").toPromise();
    };
    AuthService.prototype.getUserOb = function () {
        return __WEBPACK_IMPORTED_MODULE_2_rxjs_Observable__["a" /* Observable */].of(USER);
    };
    AuthService.prototype.getProjectOb = function () {
        return __WEBPACK_IMPORTED_MODULE_2_rxjs_Observable__["a" /* Observable */].of(PROJECTS);
    };
    AuthService.prototype.getIndex = function () {
        return DefaultProjectIndex;
    };
    AuthService.prototype.setIndex = function (i) {
        DefaultProjectIndex = 1;
    };
    AuthService.prototype.getCurrentProjectID = function () {
        var p = PROJECTS[DefaultProjectIndex];
        if (!p) {
            this.goToLogin();
        }
        return p['id'];
    ...
    AuthService.prototype.getRol = function () {
        ...
        else if (this.user["type"] == "普通用户") {
            if (this.user['projects'].length <= 0) {
                alert("对不起，您没有被添加到任何项目，请联系管理员");
                this.goToLogin();
            }
            return this.role;
        }
        else if (this.user["type"] == "运维用户") {
            if (this.user['projects'].length <= 0) {
                alert("对不起，您没有被添加到任何项目，请联系管理员");
                this.goToLogin();
            }
...
AuthService = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_0__angular_http__["b" /* Http */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_0__angular_http__["b" /* Http */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_3__angular_router__["c" /* Router */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__angular_router__["c" /* Router */]) === "function" && _b || Object])
], AuthService);
